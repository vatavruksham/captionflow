...
export default function Terms() {
  useDocumentTitle('Terms of Service', 'CaptionFlow terms of service — usage guidelines and service agreement.');
          ...
          <div className="glass-card rounded-xl p-8 space-y-6">
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                By accessing or using CaptionFlow, you agree to be bound by these Terms of Service.
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                CaptionFlow provides AI-powered social media caption generation and content tools. We
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                All captions and content generated through CaptionFlow are your property. You retain full
                commercial rights to use, modify, and distribute generated content. We do not
                claim ownership of your posts or marketing materials.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                You agree not to use CaptionFlow to generate content that is illegal, harmful,
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                CaptionFlow is provided "as is" without warranties of any kind. We are not liable
